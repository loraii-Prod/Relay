    ...
    <main className="app-shell">
      ...
      <section className="workspace">
        ...
        <div className="summary-row">
          ...
          <div><span>MEDIA BACKEND</span><b style={{fontSize:"20px"}}>{mediaConfigured ? "READY" : "SETUP"}</b><small><StatusDot state={mediaConfigured?"ok":"warn"}/> {mediaConfigured ? "LiveKit configured" : "Credentials required"}</small></div>
        ...
        <section className="lower-grid">
          <div className="panel"><div className="panel-title"><div><span>CORE SERVICES</span></div></div><div className="event-row"><b>Database</b><span>PostgreSQL persistence</span><small><StatusDot state="ok"/> CONNECTED</small></div><div className="event-row"><b>Media</b><span>WebRTC transport provider</span><small><StatusDot state={mediaConfigured?"ok":"warn"}/> {mediaConfigured?"READY":"SETUP REQUIRED"}</small></div></div>
